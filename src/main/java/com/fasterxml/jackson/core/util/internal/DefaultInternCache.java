package com.fasterxml.jackson.core.util.internal;
 ...
 */
public final class DefaultInternCache
    extends ConcurrentHashMap<String,String> // since 2.3
    implements InternCache
{
    ...
    public final static DefaultInternCache instance = new DefaultInternCache();
    ...
    public DefaultInternCache() { super(MAX_ENTRIES, 0.8f, 4); }
